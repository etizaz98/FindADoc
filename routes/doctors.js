...
router.post('/add', function(req, res, next) {
   ...
   var query = "INSERT INTO findadoc.doctors(doc_id,full_name,category,new_patients,\
   graduation_year,practice_name,street_address,city,state,zip) VALUES(?,?,?,?,?,?,?,?,?,?)";

client.execute(query,[doc_id,req.body.full_name,req.body.category,req.body.new_patients,
	req.body.graduation_year,req.body.practice_name,req.body.street_address,req.body.city,
	req.body.state,req.body.zip], {prepare:true},
function(err,result){
	if(err){
